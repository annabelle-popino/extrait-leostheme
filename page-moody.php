...
?>
        ...
        <div class="section-intro">
            <div class="img-background" style="background-image: url('<?php the_field( 'background_image');?>');">
                ...
                <div class="text-chapeau-page text-white motion text-appear-fadein2">
                    <h3><?php the_title();?></h3>
                    <p><?php the_field( 'texte_introduction');?></p>

                    <a href="#moody" class="scroll link">
                        <img class="mouse-moody" src="http://localhost:8888/leonardovilliger/wp-content/uploads/2020/08/mouse-scroll-blanc.png"></a>
                </div>
            </div>
        </div>

    <div class="background-galerie" section-id="moody">
        <div class="yt-general motion text-appear-bottom">
            <div class="yt-cargador">
                ...
                <div class="yt-miniaturas motion text-appear-bottom">
                    ...
                    ?>
                            ...
                            <a href="javascript:chargerVideo('id-frame', '<?php the_field( 'id_vimeo');?>?autoplay=1&title=0&byline=0&portrait=0&loop=1');">
                                ...
                                <div>
                                    <h4><?php the_field( 'titre_video');?></h4>
                                    <p class="text-video-moody"><?php the_field( 'texte_de_la_video');?></p>
                                </div>
                            </a>
                    <?php endwhile; wp_reset_query(); ?>
                </div>
    ...
    <section class="section-galerie">
        <h3 class="aligncenter colorwhite motion text-appear-bottom">Galerie photos</h3>

        <div class="galerie-size motion text-appear-bottom">
            <?php echo do_shortcode('[modula id="347"]'); ?>
        </div>

        <div class="button-toggle-white motion text-appear-bottom">
            <?php echo do_shortcode('[modula-link id="347"]Voir plus de photos[/modula-link]'); ?>
        </div>
    </section>

    <section class="section-avis">
        <h3 class="aligncenter colorwhite">Témoignages</h3>

        <div id="slider">

            <p class="control_next colorwhite">Témoignage suivant <img src="http://localhost:8888/leonardovilliger/wp-content/uploads/2020/08/fleche-2-1.png"></p>
            <p class="control_prev colorwhite"><img src="http://localhost:8888/leonardovilliger/wp-content/uploads/2020/08/fleche-2.png">Témoignage précédent</p>
        <?php
        $args = array(
        ...
        <?php while (have_posts()) : the_post();
            ?>
                ...
                <li>
                    <div class="text-slide colorwhite">
                        <h4><?php the_title(); ?></h4>
                        <?php the_content(); ?>
                    </div>
                    <div class="list-background-black"></div>
    ...
    <section class="section-insta">
        ...
        <h3 class="aligncenter colorwhite motion text-appear-bottom">Instagram</h3>
        <a class="insta-moody motion text-appear-bottom" href="https://www.instagram.com/leonardovilliger.moody/">@leonardovilliger.Moody
        </a>
        <div class="insta-feed-moody motion text-appear-bottom">
            <?php echo do_shortcode('[instagram-feed user="leonardovilliger.moody"]'); ?>
        </div>
    </section>
